...
For a node.js implementation, try [node-fetch](https://github.com/bitinn/node-fetch), or [isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) if you need blob body method.
