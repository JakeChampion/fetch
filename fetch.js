...
var promiseImpl = global.Promise || function() {};
...
function consumed(body) {
    if (body.bodyUsed) {
        return promiseImpl.reject(new TypeError('Already read'));
    }
    body.bodyUsed = true;
}
...
var blobSupport = 'FileReader' in global && 'Blob' in global && (function() {
    try {
        new Blob();
        return true;
    } catch (e) {
...
function Body() {
    ...
    if (blobSupport) {
        this.blob = function() {
            ...
            return rejected ? rejected : promiseImpl.resolve(this._bodyBlob);
        };
        ...
        this.text = function() {
            var rejected = consumed(this);
            return rejected ? rejected : promiseImpl.resolve(this._bodyText);
        }
    }
